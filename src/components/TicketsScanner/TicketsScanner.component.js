        ...
        <Stack space={5} mt={0} height={'100%'}>
          ...
          <View style={styles.parent}>
            ...
            <View style={{left: 15, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', width: '63%' }}>
              <Heading size="md" color='#35424a'> Tickets Scannés ({listTicketCount}) </Heading>
            </View>
          ...
          {/* search input */}
          {listTicketCount == 0 ? <Text
          style={{alignText: 'center'}}
          > Aucun ticket scannés</Text> :
          <FlatList
            data={listTicketCount != 0 ? listTicket : listDATA}
            renderItem={_renderItem}
            keyExtractor={item => item.TCK_NUM.toString()}
